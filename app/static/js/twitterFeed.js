    ...
    callback: function(data) {
      ...
      while(n < x) {
        ...
        if (parseLinks) {
          ...
          if (printTime) {
            if (permalinks) {
              op += '<p class="time-posted"><a href="' + permalinksURL[n] +
                 '">' + times[n].getAttribute('aria-label') + '</a></p>';
            } else {
              op += '<p class="time-posted">' +
          ...
          if (tweets[n].innerText) {
            ...
            if (printTime) {
              op += '<p class="time-posted">' + times[n].innerText + '</p>';
            }
            ...
            if (printTime) {
              op += '<p class="time-posted">' + times[n].textContent + '</p>';
            }
          }
        }
